<template>
    <view class="vue-cropper" ref="cropper" :style="{ top : `${containerTop}px` }" v-show="show">
        ...
        <view class="uni-info__ft">
            <view class="uni-modal__btn uni-modal__btn_default" @tap="cancel">取消</view>
            <view class="uni-modal__btn uni-modal__btn_primary" @tap="confirm">确定</view>
        </view>
    </view>
</template>
...
<style scoped lang="css">
	...
	.vue-cropper .uni-modal__btn.uni-modal__btn_primary{
		color: #ffbb00;
	}
